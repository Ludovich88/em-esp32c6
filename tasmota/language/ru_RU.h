...
#define D_GENERATED_TODAY "Генерация сегодня"
#define D_GENERATED_YESTERDAY "Генерация вчера"
#define D_GENERATED_TOTAL "Генерация всего"
#define D_ENERGY_FLOW_STATUS "Режим энергии"
#define D_ENERGY_FLOW_IMPORT "Потребление"
#define D_ENERGY_FLOW_EXPORT "Генерация"
#define D_ENERGY_FLOW_IDLE "Ожидание"
#define D_SENSOR_AHT1X "Датчик AHT1X"
#define D_SENSOR_AHT2X "Датчик AHT2X"
#define D_SENSOR_AHT3X "Датчик AHT3X"
